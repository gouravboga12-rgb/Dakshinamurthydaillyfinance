...
export default function HowToRepayScreen({ navigation }: any) {
  ...
  const steps = [
    ...
    },
    {
      ...
      desc: `Type the UPI ID exactly:\n${upiId}\nVerify the name "${Platform.OS === 'web' ? 'Dakshinamurthy Daily Finance' : 'Dakshinamurthy Ledger'}" appears before proceeding.`,
  ...
  const handleWhatsApp = () => {
    Linking.openURL(
      `https://wa.me/${WHATSAPP_NUMBER}?text=` + (Platform.OS === 'web' ? 'Hello%20Dakshinamurthy%20Daily%20Finance,%20I%20need%20help%20with%20my%20repayment.' : 'Hello%20Dakshinamurthy%20Ledger,%20I%20need%20help%20with%20my%20repayment.')
    ).catch(() => {});
  };
    ...
    >
      ...
      <View style={styles.upiIdCard}>
        <View style={styles.upiIdLeft}>
          ...
          <Text style={styles.upiIdVerify}>
            ✓ Verify name: <Text style={styles.upiIdVerifyName}>{Platform.OS === 'web' ? 'Dakshinamurthy Daily Finance' : 'Dakshinamurthy Ledger'}</Text>
          </Text>
        </View>
      ...
      <View style={styles.fraudWarning}>
        ...
        <Text style={styles.fraudText}>
          ...
          {Platform.OS === 'web' ? 'Dakshinamurthy Daily Finance' : 'Dakshinamurthy Ledger'} will NEVER ask you to pay through an unknown link.
        </Text>
      </View>
